...
void main() {
  ...
  group("Applications Overview Watcher bloc", () {
     final mockApps = [
        ApplicationHighlight(applicationId: ApplicationId(applicationId: "123"), name: Name("Hello Msg"), admissionStatus: AdmissionStatus(admissionStatusStr: "pending")),
        ApplicationHighlight(applicationId: ApplicationId(applicationId: "32"), name: Name("Hello Msg"), admissionStatus: AdmissionStatus(admissionStatusStr: "accepted")),
        ApplicationHighlight(applicationId: ApplicationId(applicationId: "213"), name: Name("Hello Msg"), admissionStatus: AdmissionStatus(admissionStatusStr: "rejected")),
      ];

    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>("should emit nothing.",
        build: () =>
    ...
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        ...
        build: () {
          when(adminApplicationRepository.getServerApplicationsAdmin()).thenAnswer((_) async => right(mockApps));
    ...
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        ...
        build: () {
          ...
          return  ApplicationsOverviewWatcherBloc(adminApplicationRepository);},
        act: (bloc) =>
            bloc.add(const ApplicationsOverviewWatcherEvent.watchPendingStarted()),
        expect: () => [
              const ApplicationsOverviewWatcherState.loadInProgress(),
    ...
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        ...
        build: () {
          ...
          return  ApplicationsOverviewWatcherBloc(adminApplicationRepository);},
        act: (bloc) =>
            bloc.add(const ApplicationsOverviewWatcherEvent.watchAcceptedStarted()),
        expect: () => [
              const ApplicationsOverviewWatcherState.loadInProgress(),
    ...
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        ...
        build: () {
          ...
          return  ApplicationsOverviewWatcherBloc(adminApplicationRepository);},
        act: (bloc) =>
            bloc.add(const ApplicationsOverviewWatcherEvent.watchRejectedStarted()),
        expect: () => [
              const ApplicationsOverviewWatcherState.loadInProgress(),
    ...
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        ...
        build: () {
          when(adminApplicationRepository.getServerApplicationsAdmin()).thenAnswer((_) async => left(const ApplicationFailure.serverError()));
          return  ApplicationsOverviewWatcherBloc(adminApplicationRepository);},
        act: (bloc) =>
            bloc.add(const ApplicationsOverviewWatcherEvent.watchAllStarted()),
        expect: () => const [
              ApplicationsOverviewWatcherState.loadInProgress(),
              ApplicationsOverviewWatcherState.loadFailed(ApplicationFailure.serverError()),
            ]);
    blocTest<ApplicationsOverviewWatcherBloc, ApplicationsOverviewWatcherState>(
        "should emit load failed because of no connection.",
        build: () {
          when(adminApplicationRepository.getServerApplicationsAdmin()).thenAnswer((_) async => left(const ApplicationFailure.noConnection()));
          return  ApplicationsOverviewWatcherBloc(adminApplicationRepository);},
        act: (bloc) =>
            bloc.add(const ApplicationsOverviewWatcherEvent.watchAllStarted()),
        expect: () => const [
              ApplicationsOverviewWatcherState.loadInProgress(),
              ApplicationsOverviewWatcherState.loadFailed(ApplicationFailure.noConnection()),
            ]);
  });
}
